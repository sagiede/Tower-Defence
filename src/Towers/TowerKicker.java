...
public class TowerKicker extends Tower {

	
	public TowerKicker(int ticksToAct, int x,int y,int toX,int toY, int speed, int threatArea) {
		super(ticksToAct, x, y, toX, toY, speed,threatArea);
	}

	//attack all the cells in range
	...
	//private assistant func to attack all the cells in range
